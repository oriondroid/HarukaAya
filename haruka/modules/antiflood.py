...
def check_flood(bot: Bot, update: Update) -> str:
    ...
    try:
        ...
        msg.reply_text(tld(chat.id, "Done playing with you freaks! *Muted*!"))
        ...
        msg.reply_text(tld(chat.id, "Insufficient permissions! Until then, I'll disable antiflood."))
    ...
    if len(args) >= 1:
        ...
        if val == "off" or val == "no" or val == "0":
            ...
            if amount <= 0:
                ...
                message.reply_text(tld(chat.id, "Antiflood has been updated to {}").format(amount))
                return "<b>{}:</b>" \
                       "\n#SETFLOOD" \
                       "\n<b>Admin:</b> {}" \
...
def __chat_settings__(bot, update, chat, chatP, user):
    ...
    if limit == 0:
        ...
        return "Antiflood updated to `{}` messages.".format(limit)
